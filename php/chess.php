...
$sql = "SELECT * FROM user_data WHERE ChessCount>0";
...
while($row = $result->fetch_assoc()) {
  ...
  $game3 = getScoreWithTime($row["ChessScore1"],$row["ChessTime1"],$row["ChessScore2"],$row["ChessTime2"],$row["ChessScore3"],$row["ChessTime3"]);
  $object["ChessScore"] = $game3[0];
  $object["ChessTime"] = $game3[1];
