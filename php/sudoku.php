...
while($row = $result->fetch_assoc()) {
  ...
  $game2 = getScoreWithTime($row["SudokuScore1"],$row["SudokuTime1"],$row["SudokuScore2"],$row["SudokuTime2"],$row["SudokuScore3"],$row["SudokuTime3"]);
  $object["SudokuScore"] = $game2[0];
  $object["SudokuTime"] = $game2[1];
